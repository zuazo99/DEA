...
public interface ListADT<T> {
		...
		public void setDescr(String izena); //deskribapena esleitzen dua
		public String getDescr(); //Deskribapena bueltatzen du
		public T removeFirst(); //listako lehen elementua kendua da
